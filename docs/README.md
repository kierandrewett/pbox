...
| [Snapshots and checkpoints](snapshots.md) | Saving environments, rollback and recovery |

For contributions: [build and test guide](development.md) and
[CLI design system](cli-design.md).
